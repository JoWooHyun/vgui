...
| 카테고리 | 아이콘 | 용도 |
|----------|--------|------|
| **네비게이션** | ARROW_LEFT, ARROW_UP, ARROW_DOWN, HOME | 방향, 홈 |
...
| **PrintPage** | print_page.py | 파일 목록 (그리드) |
